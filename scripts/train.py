...
def main():
    ...
    save_model(model, model_storage=MODEL_STORAGE, path=LOCAL_REGISTRY_PATH, filename=args.output, bucket_name=BUCKET_NAME, mlflow_tracking_uri=MLFLOW_TRACKING_URI, mlflow_model_name=MLFLOW_MODEL_NAME)
